        ...
        <div className="max-w-4xl">
          ...
          >
            <a
              ...
              className="inline-flex items-center justify-center bg-white hover:bg-white/90 text-secondary px-3 sm:px-3.5 md:px-4 py-1.5 sm:py-2 md:py-2 rounded-md font-medium text-xs sm:text-xs md:text-sm transition-all duration-300 btn-shadow hover:shadow-lg group touch-manipulation"
            >
              Fale conosco
              <ArrowRight className="ml-1 sm:ml-1.5 group-hover:translate-x-1 transition-transform" size={14} />
            </a>
            <a
              href="#produtos"
              onClick={(e) => {
              ...
              className="inline-flex items-center justify-center bg-white/10 hover:bg-white/20 text-white border border-white/60 hover:border-white px-3 sm:px-3.5 md:px-4 py-1.5 sm:py-2 md:py-2 rounded-md font-medium text-xs sm:text-xs md:text-sm transition-all duration-300 backdrop-blur-sm touch-manipulation"
            >
              Ver produtos
            </a>
          </motion.div>
