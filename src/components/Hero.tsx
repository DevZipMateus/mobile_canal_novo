        ...
        <div className="max-w-4xl">
          ...
          >
            <a
              ...
              className="inline-flex items-center justify-center bg-white hover:bg-white/90 text-secondary px-4 sm:px-5 md:px-6 lg:px-8 py-2.5 sm:py-3 md:py-3.5 rounded-lg font-semibold text-xs sm:text-sm md:text-base transition-all duration-300 btn-shadow hover:shadow-xl group touch-manipulation"
            >
              Fale conosco
            ...
            <a
              ...
              className="inline-flex items-center justify-center bg-white/10 hover:bg-white/20 text-white border-2 border-white/60 hover:border-white px-4 sm:px-5 md:px-6 lg:px-8 py-2.5 sm:py-3 md:py-3.5 rounded-lg font-semibold text-xs sm:text-sm md:text-base transition-all duration-300 backdrop-blur-sm touch-manipulation"
            >
              Ver produtos
            </a>
          </motion.div>
