  ...
  return (
    <section id="sobre" className="section-padding relative overflow-hidden" ref={sectionRef}>
      ...
      <div className="container-custom px-4 sm:px-6 lg:px-8 2xl:px-12 relative z-10">
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-16 2xl:gap-20 items-center">
          {/* Image */}
          <motion.div 
          ...
          >
            <div className="relative rounded-xl sm:rounded-2xl overflow-hidden shadow-lg">
              <img
                ...
                className="w-full h-[220px] xs:h-[260px] sm:h-[300px] md:h-[340px] lg:h-[420px] xl:h-[460px] 2xl:h-[520px] object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
            </div>
            <motion.div 
              className="absolute -bottom-3 -right-3 sm:-bottom-4 sm:-right-4 md:-bottom-6 md:-right-6 bg-secondary text-secondary-foreground p-3 sm:p-4 md:p-5 lg:p-6 2xl:p-7 rounded-lg sm:rounded-xl shadow-xl"
              initial={{ opacity: 0, scale: 0.8 }}
              animate={isInView ? { opacity: 1, scale: 1 } : {}}
              transition={{ duration: 0.5, delay: 0.3 }}
            >
              <div className="text-center">
                <div className="text-2xl sm:text-3xl md:text-4xl 2xl:text-5xl font-bold">✓</div>
                <div className="text-[10px] sm:text-xs md:text-sm 2xl:text-base whitespace-nowrap">Qualidade garantida</div>
              </div>
            </motion.div>
          </motion.div>
          ...
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-4xl 2xl:text-5xl font-bold mb-3 sm:mb-4 md:mb-6 text-foreground">
              Sobre nós
            </h2>
            <p className="text-sm sm:text-base md:text-lg 2xl:text-xl text-muted-foreground mb-4 sm:mb-6 md:mb-8 leading-relaxed">
            ...
            <div className="space-y-3 sm:space-y-4 md:space-y-6 mb-6 md:mb-8">
              ...
              >
                ...
                <div className="min-w-0">
                  <h3 className="text-base sm:text-lg md:text-xl 2xl:text-2xl font-semibold mb-1">Missão</h3>
              ...
              >
                ...
                <div className="min-w-0">
                  <h3 className="text-base sm:text-lg md:text-xl 2xl:text-2xl font-semibold mb-1">Visão</h3>
                  <p className="text-xs sm:text-sm md:text-base 2xl:text-lg text-muted-foreground">
        ...
        {/* Values Section */}
        <motion.div 
          className="mt-10 sm:mt-12 md:mt-16 2xl:mt-20"
        ...
        >
          <div className="flex gap-3 sm:gap-4 mb-4 sm:mb-6">
            ...
            <div>
              <h3 className="text-base sm:text-lg md:text-xl 2xl:text-2xl font-semibold mb-0.5 sm:mb-1">Nossos valores</h3>
            </div>
          </div>
          <div className="grid grid-cols-2 xs:grid-cols-3 md:grid-cols-5 gap-3 sm:gap-4 md:gap-5 lg:gap-6 2xl:gap-8">
            {values.map((value, index) => {
              const Icon = value.icon;
              return (
                <motion.div 
                  key={index} 
                  className="bg-card border border-border rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 lg:p-6 2xl:p-8 text-center card-hover group cursor-pointer card-glow shine-effect icon-float"
                  variants={itemVariants}
                  whileHover={{ scale: 1.05, y: -6 }}
                  transition={{ type: 'spring', stiffness: 300 }}
                >
                  <div className="w-9 h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 2xl:w-14 2xl:h-14 bg-secondary/10 rounded-lg flex items-center justify-center mx-auto mb-2 sm:mb-3 group-hover:bg-secondary/20 transition-all duration-500 icon-float-target">
                    <Icon className="text-secondary" size={18} />
                  </div>
                  <h4 className="font-semibold text-xs sm:text-sm md:text-base 2xl:text-lg mb-0.5 sm:mb-1">{value.title}</h4>
                  <p className="text-[10px] sm:text-xs md:text-sm 2xl:text-base text-muted-foreground leading-tight">{value.description}</p>
                </motion.div>
              );
            })}
          </div>
        ...
        {/* Market Section */}
        <motion.div 
          className="mt-10 sm:mt-12 md:mt-16 2xl:mt-20 bg-card border border-border rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 2xl:p-10"
        ...
        >
          <div className="flex gap-3 sm:gap-4 mb-3 sm:mb-4">
            ...
            <div>
              <h3 className="text-base sm:text-lg md:text-xl 2xl:text-2xl font-semibold mb-0.5 sm:mb-1">Mercado de atuação</h3>
            </div>
          </div>
          <p className="text-xs sm:text-sm md:text-base 2xl:text-lg text-muted-foreground leading-relaxed">
